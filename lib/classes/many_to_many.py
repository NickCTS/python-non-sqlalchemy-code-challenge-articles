...
class Magazine:
    ...
    def article_titles(self):
        """Return a list of article titles for this magazine, or None if there are no articles."""
    ...
    def contributing_authors(self):
        ...
        # Return list of authors who have written more than 2 articles
        contributing_authors = [author for author, count in author_count.items() if count > 2]

        # Return None if no author has written more than 2 articles
